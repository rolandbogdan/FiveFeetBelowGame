...
namespace FiveFeetBelowGame.UI
{
    ...
    class Renderer
    {
        ...
        // public Brush RockBrush { get { return this.GetBrush("FiveFeetBelowGame.Images.tileset.png", false); } }
        ...
        private Drawing GetPlayer()
        {
                  ...
                  this.oldPlayerPosition.Y != this.model.Player.CY))
            {
                Geometry g = new RectangleGeometry(
                    new Rect(
                        this.model.Player.CX * this.model.TileSize,
                        this.model.Player.CY * this.model.TileSize,
                        this.model.TileSize,
                        this.model.TileSize));
