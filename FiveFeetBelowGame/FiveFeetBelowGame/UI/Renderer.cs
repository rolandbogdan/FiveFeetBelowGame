...
namespace FiveFeetBelowGame.UI
{
      ...
      class Renderer
      {
            ...
            public Drawing BuildDrawing()
            {
                  ...
                  dg.Children.Add(this.GetInventory());
            ...
            private Drawing GetInventory()
            {
                  DrawingGroup dg = new DrawingGroup();
                  if (this.oldInventory == null)
                  {
                        Geometry g = new RectangleGeometry(new Rect(0, 0, 50, 50));
                        this.oldInventory = new GeometryDrawing(Brushes.Black, null, g);

                        dg.Children.Add(this.oldInventory);
                        dg.Children.Add(this.oldInventory);
                        dg.Children.Add(this.oldInventory);
                        dg.Children.Add(this.oldInventory);
                        dg.Children.Add(this.oldInventory);
