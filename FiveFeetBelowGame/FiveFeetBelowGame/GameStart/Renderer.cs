...
namespace FiveFeetBelowGame
{
      ...
      public class Renderer
      {
            ...
            public Brush RockBrush
            {
                  get
                  {
                        return this.GetBrush("FiveFeetBelowGame.Images.rock.png", false);
                  }
            }
            ...
            public Brush WallBrush
            {
                  get
                  {
                        return this.GetBrush("FiveFeetBelowGame.Images.Bedrock.png", false);
                  }
            }
            ...
            public Brush IronBrush
            {
                  get
                  {
                        return this.GetBrush("FiveFeetBelowGame.Images.iron.png", false);
                  }
            }
            ...
            public Brush GoldBrush
            {
                  get
                  {
                        return this.GetBrush("FiveFeetBelowGame.Images.Gold-Ore.png", false);
                  }
            }
            ...
            public Brush DiaBrush
            {
                  get
                  {
                        return this.GetBrush("FiveFeetBelowGame.Images.diamond-ore.png", false);
                  }
            }
            ...
            public Brush GemBrush
            {
                  get
                  {
                        return this.GetBrush("FiveFeetBelowGame.Images.emerald-ore.png", false);
                  }
            }
            ...
            public Brush RareGemBrush
            {
                  get
                  {
                        return this.GetBrush("FiveFeetBelowGame.Images.rare-gem.png", false);
                  }
            }
            ...
            public Drawing BuildDrawing()
            {
                  ...
                  foreach (Drawing item in this.GetRocks())
                  {
                        dg.Children.Add(item);
                  }
            ...
            private List<Drawing> GetRocks()
            {
                  if (this.oldRocks == null)
                  {
                        this.oldRocks = new List<Drawing>();
                        for (int x = 0; x < this.model.Blocks.GetLength(1); x++)
                        {
                              for (int y = 0; y < this.model.Blocks.GetLength(0); y++)
                              {
                                    Brush b = Brushes.Transparent;
                                    if (this.model.Blocks[y, x] != null && (this.model.Blocks[y, x] as OneBlock) != null && (this.model.Blocks[y, x] as OneBlock).Type == BlockType.Rock)
                                    {
                                          b = this.RockBrush;
                                    }

                                    Geometry box = new RectangleGeometry(new Rect(y * this.model.TileSize, x * this.model.TileSize, this.model.TileSize, this.model.TileSize));
                                    this.oldRocks.Add(new GeometryDrawing(b, null, box));
                              }
                        }
                  }
