...
[assembly: SuppressMessage("Performance", "CA1814:Prefer jagged arrays over multidimensional", Justification = "<Pending>", Scope = "member", Target = "~M:FiveFeetBelowGame.BL.LevelGenerator.GenerateSectionJson(FiveFeetBelowGame.VM.GameItem[,])~FiveFeetBelowGame.VM.GameItem[,]")]
[assembly: SuppressMessage("Performance", "CA1814:Prefer jagged arrays over multidimensional", Justification = "<Pending>", Scope = "member", Target = "~M:FiveFeetBelowGame.BL.LevelGenerator.GenerateFirstSectionJson~FiveFeetBelowGame.VM.GameItem[,]")]
